...
class MetricCacheProcessor:
    ...
    def compute_metric_cache(self, scenario: AbstractScenario) -> Optional[CacheMetadataEntry]:
        ...
        #scorer._calculate_driving_direction_compliance()
        ...
        # centerline_list=[]
        # for discrete_path in _centerline._discrete_path:
        #     point=np.array([discrete_path.x,discrete_path.y,discrete_path.heading]).astype(np.float32)
        #     centerline_list.append(point)

        # _centerline._linestring = None
        # _centerline._states_se2_array=None
        # _centerline._interpolator = None
        ...
        # return metadata _drivable_area_map 21 _centerline 10 route 0 observation 6
        return CacheMetadataEntry(file_name)

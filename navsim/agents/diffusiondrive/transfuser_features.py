...
class TransfuserFeatureBuilder(AbstractFeatureBuilder):
    ...
    def compute_features(self, agent_input: AgentInput) -> Dict[str, torch.Tensor]:
        ...
        features["camera_feature"],features["camera_valid"] = self._get_camera_feature(agent_input)
        features["rendered_camera_feature"],features["rendered_camera_valid"] = self._get_camera_feature(agent_input,synthetic=True)
    ...
    def _get_camera_feature(self, agent_input: AgentInput,synthetic=False) -> torch.Tensor:
        """
        ...
        if self._config.waymo:
            l0 = cameras.cam_l0.image[350:]
            f0 = cameras.cam_f0.image[350:]
            r0 = cameras.cam_r0.image[350:]
            is_valid = torch.tensor(cameras.cam_f0.real_valid)
        else:
            if synthetic:
                l0 = cameras.cam_l0.rendered_image[28:-28, 416:-416]
                f0 = cameras.cam_f0.rendered_image[28:-28]
                r0 = cameras.cam_r0.rendered_image[28:-28, 416:-416]

...
class TransfuserConfig:
    ...
    waymo = True
    distill_feature: bool = False if waymo else True
    trajectory_sampling: TrajectorySampling = TrajectorySampling(4, interval_length=0.5)

    image_architecture: str = "resnet34"
    lidar_architecture: str = "resnet34"
    #bkb_path: str = "/home/users/bencheng.liao/.cache/huggingface/hub/checkpoints/resnet34.a1_in1k/pytorch_model.bin"
    plan_anchor_path = os.path.join(os.path.dirname(__file__), "kmeans_womd_20.npy") if waymo else os.path.join(os.path.dirname(__file__), "kmeans_navsim_traj_20.npy")
    latent: bool = True
